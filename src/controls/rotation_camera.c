...
/*   Updated: 2024/09/27 17:09:45 by mateo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	rotate_x(&meta_data->img_right, meta_data->pixel.theta_x);
	rotate_x(&meta_data->img_forward, meta_data->pixel.theta_x);
	rotate_x(&meta_data->img_up, meta_data->pixel.theta_x);
	rotate_y(&meta_data->img_right, meta_data->pixel.theta_y);
	rotate_y(&meta_data->img_forward, meta_data->pixel.theta_y);
	rotate_y(&meta_data->img_up, meta_data->pixel.theta_y);
	rotate_z(&meta_data->img_right, meta_data->pixel.theta_z);
	rotate_z(&meta_data->img_forward, meta_data->pixel.theta_z);
	rotate_z(&meta_data->img_up, meta_data->pixel.theta_z);
